			...
			<div class='container'>
				...
				echo "<div class='phone-info {$phone_class}'><span>";
					if ( is_user_logged_in() ) {
						global $current_user;
						echo 'Hey ' . $current_user->first_name;
						echo ' | <a href="'.wp_logout_url('/') .'" title="Logout">Logout</a>';
					} else {
						echo '<a href="/myteklist-register-um">Référencer mon entreprise</a> | <a href="/prospect-registration">S’inscrire</a> | <a href="/myteklist-login-um">Connexion</a>';
					}
				echo '</span></div>';				
